...
mkisofs -o c2cloud_openstack_kilo.iso -b isolinux/isolinux.bin -c isolinux/boot.cat -no-emul-boot -boot-load-size 4 -boot-info-table -R -J -V "centos7_install" -v -T $ISODIR
